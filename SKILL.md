...
Knowledge base — answer internal questions about how the AWS offer works.
Sales copilot — when asked, suggest how to respond to a prospect or handle a specific situation.
